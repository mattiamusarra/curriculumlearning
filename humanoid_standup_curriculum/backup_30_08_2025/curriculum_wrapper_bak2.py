...
class ImprovedCurriculumWrapper(gym.Wrapper):
    ...
    4. Posizione quadrupede - Alzarsi su mani e ginocchia
    ...
    def __init__(self, env):
        ...
        self.tasks = [
            ...
            {
                'name': 'Posizione quadrupede',
                'description': 'Alzarsi su mani e ginocchia',
                'reward_weight': 1.3,
            ...
            },
            {
                ...
                'description': 'Portarsi in squat profondo stabile',
                'reward_weight': 1.5,
        ...
        print(f" Curriculum Learning  inizializzato")
    ...
    def reset(self, **kwargs):
        """RESET DELL'AMBIENTE CON GESTIONE DEL CURRICULUM"""
    ...
    def _calculate_detailed_curriculum_reward(self, obs, base_reward, done):
        """CALCOLA IL REWARD PER OGNI TASK"""
        ...
        #AGGIRNA LA HISTORY PER ANALISI STABILITÀ
    ...
    def _update_curriculum_progress(self):
        ...
        #STAMPA SOLO OGNI 5 SUCCESSI PER EVITARE SPAM
        """
        if self.task_success_count % 5 == 0 or self.task_success_count <= 5:
            print(f"\n SUCCESSO Task {self.current_task + 1}!")
            ...
            if self.current_task == 7:
                print(f"   Steps in equilibrio: {self.steps_standing}")
        """
